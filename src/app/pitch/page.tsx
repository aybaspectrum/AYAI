    ...
    <div className="container py-12 max-w-4xl mx-auto">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary via-purple-400 to-pink-500 bg-clip-text text-transparent">
          Spectrum: Navigating the Agentic Age with Human-Centric AI Orchestration
        </h1>
      </header>
      ...
      <main className="space-y-16">
           ...
           <div className="space-y-4 text-muted-foreground text-justify">
            <p>SpectrumAI is an essential navigation system for the Agentic Age. It is engineered to abstract away the dizzying complexity of agentic execution, providing human leaders with a clear, intuitive, and powerful platform for strategic command and control.</p>
             ...
             <div className="grid md:grid-cols-3 gap-6 pt-4">
                <Card>
                    <CardHeader><CardTitle>Strategic Visualization Interface</CardTitle></CardHeader>
                    <CardContent>A dynamic, drag-and-drop canvas to map strategic initiatives and make complex processes immediately legible.</CardContent>
                </Card>
                <Card>
                    <CardHeader><CardTitle>Agentic Workflow Designer</CardTitle></CardHeader>
                    <CardContent>A low-code interface to design and assign agentic workflows using a library of pre-built, customizable agent templates.</CardContent>
                </Card>
                <Card>
        ...
        {/* Market Position */}
        <section>
          <h2 className="text-3xl font-bold mb-4 border-b pb-2">Strategic Market Position</h2>
          <div className="mt-6 border rounded-lg">
            <div className="grid grid-cols-4 font-semibold border-b bg-secondary">
        ...
        {/* PESTLE Analysis */}
        <section>
          <h2 className="text-3xl font-bold mb-4 border-b pb-2">PESTLE Analysis</h2>
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>Massive AI investment is a tailwind, but high project failure rates create skepticism. Spectrum is positioned as a de-risking platform that ensures ROI.</CardContent>
            </Card>
            <Card>
            ...
            <Card>
              ...
              <CardContent>The proliferation of complex agentic frameworks creates a clear need for a stable orchestration layer like Spectrum.</CardContent>
            </Card>
            <Card>
