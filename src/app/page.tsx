                ...
                <Link href="/timeline" className="block">
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 ml-3">Timeline View</h3>
                    </div>
                    <p className="text-gray-600">Visualize your career journey with an interactive timeline.</p>
                  </div>
                </Link>
